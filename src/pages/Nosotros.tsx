          ...
          <div className="relative space-y-16">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="md:pl-16">
                <div className="h-64 md:h-80 rounded-xl overflow-hidden shadow-md">
                  <img className="w-full h-full object-cover" src="/trayectoria1.webp" alt={t.alt_history1_img} loading="lazy" />
                </div>
              </div>
            </div>
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="md:order-1 md:pr-16">
                <div className="h-64 md:h-80 rounded-xl overflow-hidden shadow-md">
                  <img className="w-full h-full object-cover" src="/trayectoria2.webp" alt={t.alt_history2_img} loading="lazy" />
                </div>
              </div>
            </div>
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="md:pl-16">
                <div className="h-64 md:h-80 rounded-xl overflow-hidden shadow-md">
                  <img className="w-full h-full object-cover" src="/trayectoria3.webp" alt={t.alt_history3_img} loading="lazy" />
                </div>
              </div>
            </div>
          </div>
