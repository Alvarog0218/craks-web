      ...
      <section className="relative px-6 md:px-12 py-16 md:py-24 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center overflow-hidden">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary-container text-on-secondary-container mb-8">
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Global Logistics Elite</span>
          </div>
          <h1 className="font-headline text-4xl md:text-6xl font-extrabold text-on-background tracking-tighter leading-[1.05] mb-6">
            Logística de <span className="text-secondary">Precisión</span> para el Alcance Global.
          </h1>
          <p className="text-on-surface-variant text-lg max-w-xl mb-10 leading-relaxed">
            Elevamos los estándares de distribución B2B. Conectamos su producción con el mercado global mediante una cadena de frío inteligente y trazabilidad total.
          </p>
          ...
          <div className="relative bg-surface-container-low rounded-xl overflow-hidden p-3 shadow-2xl">
            ...
            <div className="absolute bottom-8 left-8 p-5 bg-surface/90 backdrop-blur-md rounded-xl max-w-xs shadow-lg">
              <div className="flex items-center gap-3 mb-1">
                ...
                <span className="font-bold text-secondary text-sm">Certificación Craks</span>
              </div>
              <p className="text-sm">99.9% de efectividad en entregas refrigeradas transcontinentales.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-surface-container-low">
        <div className="px-6 md:px-12 max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-14">
            <h2 className="font-headline text-3xl md:text-5xl font-extrabold tracking-tight mb-4">Nuestra Red Global</h2>
            <p className="text-on-surface-variant text-lg">Más de 45 centros de distribución estratégicos conectando los continentes con precisión quirúrgica.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            <div className="p-6 bg-surface rounded-xl">
              <div className="text-3xl md:text-4xl font-black text-secondary mb-1 font-headline">120+</div>
              <div className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Países Cubiertos</div>
            </div>
            <div className="p-6 bg-surface rounded-xl">
              <div className="text-3xl md:text-4xl font-black text-secondary mb-1 font-headline">1.2M</div>
              <div className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Envíos Anuales</div>
            </div>
            <div className="p-6 bg-surface rounded-xl">
              <div className="text-3xl md:text-4xl font-black text-secondary mb-1 font-headline">0.02%</div>
              <div className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Margen de Error</div>
            </div>
            <div className="p-6 bg-surface rounded-xl">
              <div className="text-3xl md:text-4xl font-black text-secondary mb-1 font-headline">24h</div>
              <div className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Soporte Crítico</div>
            </div>
          </div>
      ...
      <section id="soluciones" className="py-16 md:py-24 bg-surface px-6 md:px-12">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="font-headline text-3xl md:text-5xl font-extrabold tracking-tight mb-10">Tecnología de Vanguardia e Integridad Orgánica</h2>
            <div className="space-y-8">
              <div className="flex gap-5">
                <div className="flex-shrink-0 w-14 h-14 rounded-full bg-primary-fixed flex items-center justify-center">
                  <span className="material-symbols-outlined text-on-primary-fixed text-2xl">ac_unit</span>
                </div>
                <div>
                  <h4 className="text-lg font-bold mb-1">Control Térmico Activo</h4>
                  <p className="text-on-surface-variant leading-relaxed">Sensores de grado médico que mantienen la temperatura exacta desde el origen hasta el destino final, sin oscilaciones.</p>
                </div>
              </div>
              <div className="flex gap-5">
                <div className="flex-shrink-0 w-14 h-14 rounded-full bg-primary-fixed flex items-center justify-center">
                  <span className="material-symbols-outlined text-on-primary-fixed text-2xl">token</span>
                </div>
                <div>
                  <h4 className="text-lg font-bold mb-1">Blockchain Traceability</h4>
                  <p className="text-on-surface-variant leading-relaxed">Cada lote es registrado en un libro mayor inmutable. Transparencia total para socios y consumidores finales.</p>
                </div>
              </div>
              <div className="flex gap-5">
                <div className="flex-shrink-0 w-14 h-14 rounded-full bg-primary-fixed flex items-center justify-center">
                ...
                <div>
                  <h4 className="text-lg font-bold mb-1">Rutas Optimizadas (IA)</h4>
                  <p className="text-on-surface-variant leading-relaxed">Algoritmos de aprendizaje profundo reducen la huella de carbono minimizando tiempos de espera y recorridos.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-surface p-8 md:p-10 rounded-xl group hover:bg-secondary transition-all duration-500 ghost-border">
              ...
              <p className="text-on-surface-variant group-hover:text-white/80 leading-relaxed text-sm">Prioridad absoluta en el reabastecimiento de inventario crítico con cláusulas de cumplimiento por contrato.</p>
            </div>
            <div className="bg-surface p-8 md:p-10 rounded-xl group hover:bg-secondary transition-all duration-500 ghost-border">
            ...
            <div className="bg-surface p-8 md:p-10 rounded-xl group hover:bg-secondary transition-all duration-500 ghost-border">
              ...
              <p className="text-on-surface-variant group-hover:text-white/80 leading-relaxed text-sm">Acceso a nuestras certificaciones internacionales (ISO, Organic Precision) para fortalecer su propuesta de valor.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <div className="p-7 bg-surface-container rounded-xl border-l-4 border-secondary">
              <p className="italic text-on-surface font-medium leading-relaxed">"Craks Logistics transformó nuestra capacidad de entrega en mercados asiáticos, reduciendo las mermas en un 40% desde el primer mes."</p>
              <div className="mt-5 flex items-center gap-4">
                <div className="w-11 h-11 rounded-full bg-surface-container-highest"></div>
                <div>
                  <div className="font-bold text-sm">Marco Valenzuela</div>
                  <div className="text-xs text-on-surface-variant">Director de Operaciones, Global Food Group</div>
                </div>
              </div>
            </div>
          </div>
