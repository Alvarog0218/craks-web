      ...
      <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1 flex flex-col gap-4">
          ...
          <div className="flex gap-3 mt-2">
            <a href="#" className="w-9 h-9 rounded-full bg-surface-container-highest flex items-center justify-center text-on-surface-variant hover:text-petrol transition-colors">
